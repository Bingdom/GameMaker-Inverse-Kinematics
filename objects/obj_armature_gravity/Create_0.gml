...
// Note- if gravity is too small, you will need to decrease the ik threshold
// Otherwise the movement is too small, to detect a valid move for ik
grav = 0.1 
frict = 0.99; // Motion loss over time
hspd = 0;
vspd = 0;

ball_pos = {x: armature.point_end().x, y: armature.point_end().y}
#endregion